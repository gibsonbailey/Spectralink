...
int main(int argc, char ** argv){
    ...
    char* datafile = argv[0];
    char* x_location = argv[1];
    char* y_location = argv[2];
    char* z_location = argv[3];
    ...
    { 
        ...
        float dist = (float)sqrt((double)((x_src - x_lst) * (x_src - x_lst) + ((z_src - z_lst) * (z_src - z_lst)) + ((y_src - y_lst) * (y_src -
        y_lst))));
        x_src /= dist;
        y_src /= dist;
        z_src /= dist;
